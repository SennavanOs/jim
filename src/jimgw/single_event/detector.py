...
class TriangularNetwork2G: # TODO: do we want this to be a subclass of detector or not?
    polarization_mode: list[Polarization]
    ...
    def __init__(self,
                 ...
                 **kwargs):
        """
        List of a triangular interferometer network. The single detecotor are based on the GroundBased2G class.
        """
        ...
        self.xarm_azimuth = kwargs.get("xarm_azimuth", 0.0)
        self.yarm_azimuth = kwargs.get("yarm_azimuth", 0.0)
        self.xarm_tilt = kwargs.get("xarm_tilt", 0.0)
        self.yarm_tilt = kwargs.get("yarm_tilt", 0.0)
        modes = kwargs.get("mode", "pc")
        self.polarization_mode = [Polarization(m) for m in modes]
    ...
    def inject_signal(
        ...
        for detector in self.ifos:
            key, subkey = jax.random.split(key)
            detector.inject_signal(subkey, freqs, h_sky, params, psd_file)
